ginpipe configs/default_parameters.gin \
        ...
        --mods "tasks.models.S3PRLUpstreamMLPDownstreamForCls.frozen_upstream=True" "tasks.models.S3PRLUpstreamMLPDownstreamForCls.normalize_upstream_embeddings=False" "tasks.models.save_upstream_embeddings.saving_path='/home/eernst/Voxceleb1/avg_embeddings'" "tasks.models.save_upstream_embeddings.extract_embedding_method=@tasks.models.extract_upstream_embedding_w_temporal_average_pooling"
...
ginpipe configs/default_parameters.gin \
        ...
        --mods "tasks.models.S3PRLUpstreamMLPDownstreamForCls.frozen_upstream=True" "tasks.models.S3PRLUpstreamMLPDownstreamForCls.normalize_upstream_embeddings=True" "tasks.models.S3PRLUpstreamMLPDownstreamForCls.normalization_method='standard_normalization'" "tasks.models.save_upstream_embeddings.saving_path='/home/eernst/Voxceleb1/avg_embeddings'" "tasks.models.save_upstream_embeddings.extract_embedding_method=@tasks.models.extract_upstream_embedding_w_temporal_average_pooling"
